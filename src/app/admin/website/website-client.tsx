...
export default function WebsiteClient({
    ...
    company: {name: string; email: string | null; phone: string | null; address: string | null} | null;
                    ...
                    {services.map((item) => (
                        ...
                        >
                            <div className="grid gap-2 md:grid-cols-3">
                                ...
                                <select name="category" defaultValue={item.category} className="h-10 rounded-md border px-3 text-sm">
                                    <option value="pest">pest</option>
                                    <option value="other">other</option>
                                </select>
                            </div>
                            <Textarea name="summary" defaultValue={item.summary} />
                            <Textarea name="details" defaultValue={parseDetails(item.details).join("\n")} rows={4} />
