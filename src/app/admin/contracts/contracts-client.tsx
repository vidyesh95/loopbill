        ...
        <main className="flex w-full flex-col gap-4">
            <div className="flex flex-col items-start justify-between gap-2 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage customer contracts, payments, and subscription details</p>
                </div>
            ...
            <ContractDialog open={open} onOpenChange={setOpen} customers={customers} packages={packages} />
        </main>
    );
}
