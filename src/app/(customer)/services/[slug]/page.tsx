    ...
    <main>
      <header className="bg-[oklch(0.94_0.016_95)] py-20">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <h1 className="mb-6 font-display text-4xl text-foreground md:text-5xl">
            {service.title}
          </h1>
      ...
      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-4 py-20 lg:grid-cols-2">
        <article>
          <h2 className="mb-6 font-display text-2xl">How we handle it</h2>
          <ul className="space-y-4 text-muted-foreground">
            {service.details.map((detail) => (
              <li
                key={detail}
                className="rounded-2xl border border-[oklch(0.86_0.015_95)] bg-[oklch(0.99_0.008_95)] p-4"
              >
                {detail}
              </li>
            ))}
          ...
          {isPricedServiceSlug(service.slug) ? (
            <p className="mt-6 text-sm text-muted-foreground">
              ...
              <Link
                href={`/residential?service=${service.slug}`}
              ...
              {" · "}
              <Link
                href={`/commercial?service=${service.slug}`}
                className="text-primary underline-offset-4 hover:underline"
              >
                Commercial estimate
              </Link>
        ...
        <div className="rounded-2xl border border-[oklch(0.86_0.015_95)] bg-[oklch(0.99_0.008_95)] p-8">
          <h2 className="mb-2 font-display text-2xl">Request this service</h2>
