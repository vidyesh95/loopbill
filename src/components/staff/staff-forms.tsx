    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Assign an agent and a date inside the package window.
          </DialogDescription>
        </DialogHeader>
        ...
        <form action={onSubmit} className="grid gap-3">
          ...
          <Field label="Location label">
            <Input
              ...
              placeholder="Building A, Flat 304"
            />
          </Field>
          <Field label="Address">
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Must be raised in the same month as the original service.
          </DialogDescription>
        </DialogHeader>
        <form action={onSubmit} className="space-y-3">
          <Field label="Customer">
...
export function NotificationDialog({
  ...
  async function onSubmit(formData: FormData) {
    setPending(true);
    const methods = ["Email", "SMS", "WhatsApp", "Push"].filter(
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Writes to the notification log. WhatsApp/SMS are placeholders.
          </DialogDescription>
        </DialogHeader>
        <form action={onSubmit} className="space-y-3">
          <Field label="Type">
