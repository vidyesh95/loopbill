...
function ServiceCard({ slug, title, summary }: { slug: string; title: string; summary: string }) {
  ...
  return (
    <section id="services" className="bg-[oklch(0.99_0.008_95)] py-20">
      <header className="mx-auto mb-12 max-w-2xl px-4 text-center">
        ...
        <h2 className="mt-3 font-display text-3xl md:text-4xl">Pest-free living starts here</h2>
