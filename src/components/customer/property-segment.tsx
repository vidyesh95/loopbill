...
const TRUST = [
  {
    ...
    body: "Trained crews for homes, societies, kitchens, and offices.",
  },
  {
    title: "Targeted treatments",
    body: "Gel baits, termiticides, fogging, and exclusion — not a single spray for every pest.",
  },
  {
    title: "Family- and staff-safe",
    body: "Approved chemicals, protective gear, and instructions before we leave.",
  },
  {
    title: "AMC or one-time",
    body: "Same pest types, different visit rhythm. 1 Year and 2 Year plans sit on the published rate card.",
  },
];
    ...
    <main>
      ...
      <section className="border-y border-[oklch(0.86_0.015_95)] bg-[oklch(0.99_0.008_95)] py-16">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="mb-10 text-center font-display text-3xl">How a visit works</h2>
          <ol className="grid gap-4 md:grid-cols-3">
            {PROCESS.map((step, index) => (
              ...
              >
                <p className="text-xs tracking-[0.18em] text-primary uppercase">0{index + 1}</p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <h2 className="mb-10 text-center font-display text-3xl">What you can expect</h2>
