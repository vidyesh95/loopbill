...
import type {ComplaintStatusRow} from "@/lib/data/types";

const complaintStatus: ComplaintStatusRow[] = [
...
export default function ComplaintStatusBreakdown({data = complaintStatus}: {data?: ComplaintStatusRow[]}) {
    return (
        <Card>
            <CardHeader>
