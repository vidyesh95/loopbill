      ...
      <DialogContent className="sm:max-w-175">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Shield className="text-google-blue h-5 w-5" />
        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-blue-50 p-4">
            <h4 className="mb-2 text-sm font-medium">Current Role: {user.role}</h4>
          ...
          <div className="rounded-lg bg-yellow-50 p-4">
            <h4 className="mb-2 text-sm font-medium">Permission Summary:</h4>
            <div className="text-xs text-muted-foreground">
              ...
              <div>
                <span className="font-medium">Total Available:</span> {availablePermissions.length}
              </div>
            </div>
          </div>
        </div>
