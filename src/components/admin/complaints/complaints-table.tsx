      ...
      <TableBody>
        {rows.map((complaint) => (
          <TableRow key={complaint.complaintId}>
            ...
            <TableCell>
              <span
                className={`rounded-full border px-2 py-0.5 font-semibold ${getPriorityColor(complaint.priority)}`}
              >
                {complaint.priority}
              </span>
            </TableCell>
            <TableCell>
              <span
                className={`rounded-full border px-2 py-0.5 font-semibold ${getStatusColor(complaint.status)}`}
              >
                {complaint.status}
              </span>
            </TableCell>
            ...
            <TableCell className="flex gap-1">
              ...
              <Button size={"sm"}>{complaint.action}</Button>
            </TableCell>
          </TableRow>
        ))}
      </TableBody>
  ...
  return (
    <Tabs defaultValue="all-complaints" className="w-full">
      <TabsList className="grid w-full grid-cols-5">
        <TabsTrigger value="all-complaints" className="cursor-pointer">
          All complaints
        </TabsTrigger>
        <TabsTrigger value="unscheduled-complaints" className="cursor-pointer">
          Unscheduled complaints
        </TabsTrigger>
        <TabsTrigger value="scheduled-complaints" className="cursor-pointer">
          Scheduled complaints
        </TabsTrigger>
        <TabsTrigger value="in-progress-complaints" className="cursor-pointer">
          In progress complaints
        </TabsTrigger>
        <TabsTrigger value="resolved-complaints" className="cursor-pointer">
          Resolved complaints
        </TabsTrigger>
      </TabsList>
      <TabsContent value="all-complaints">
        <Card>
          ...
          <CardContent>{renderComplaints(byStatus())}</CardContent>
          <CardFooter>
      ...
      <TabsContent value="unscheduled-complaints">
        <Card>
          ...
          <CardContent>{renderComplaints(byStatus("Unscheduled"))}</CardContent>
          <CardFooter>
            <ComplaintsTablePagination />
          </CardFooter>
        </Card>
      ...
      <TabsContent value={"scheduled-complaints"}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Complaints scheduled for investigation and resolution</CardDescription>
            <FilterByPriority />
          </CardHeader>
          <CardContent>{renderComplaints(byStatus("Scheduled"))}</CardContent>
          <CardFooter>
            <ComplaintsTablePagination />
          </CardFooter>
        </Card>
      ...
      <TabsContent value={"in-progress-complaints"}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Complaints currently being investigated and resolved</CardDescription>
            <FilterByPriority />
          </CardHeader>
          <CardContent>{renderComplaints(byStatus("In progress"))}</CardContent>
          <CardFooter>
            <ComplaintsTablePagination />
          </CardFooter>
        </Card>
      ...
      <TabsContent value={"resolved-complaints"}>
        <Card>
          ...
          <CardContent>{renderComplaints(byStatus("Resolved"))}</CardContent>
          <CardFooter>
            <ComplaintsTablePagination />
          </CardFooter>
        </Card>
