          ...
          <TableBody>
            {items.map((complaints) => (
              <TableRow key={complaints.id}>
                ...
                <TableCell>
                  <span
                    className={`rounded-full border px-2 py-0.5 font-semibold ${complaints.validity === "Invalid" ? "border-red-400 bg-red-100 text-red-600" : "border-green-400 bg-green-100 text-green-600"}`}
                  >
                    {complaints.validity}
                  </span>
                </TableCell>
                <TableCell>
                  <div className="flex gap-2">
                    <Button
                      variant={complaints.validity === "Invalid" ? "destructive" : "default"}
                      size={"sm"}
                    >
