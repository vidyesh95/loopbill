...
export const SERVICES: ServiceOffering[] = [
  ...
  },
  {
    ...
    category: "pest",
    summary:
      "Reduces mosquito populations to prevent disease using larvicides, insecticides, and breeding-site removal.",
    details: [
  ...
  },
  {
    ...
    category: "pest",
    summary:
      "Prevents and eradicates termites using inspections, termiticides, baits, and physical barriers.",
    details: [
  ...
  },
  {
    ...
    category: "pest",
    summary:
      "Eradicates wood-boring insects with treatments, fumigation, and wood preservation techniques.",
    details: [
  ...
  },
  {
    ...
    category: "other",
    summary:
      "Nylon-coated stainless steel balcony and window grills that stay nearly invisible while keeping children, pets, and pests out.",
    details: [
  ...
  },
  {
    ...
    category: "other",
    summary:
      "Humane bird netting and spikes that stop pigeons from roosting on ledges, AC units, and signage.",
    details: [
  ...
  },
  {
    ...
    category: "other",
    summary:
      "Metal guards on pipes and cables that stop rats from climbing into kitchens, shafts, and upper floors.",
    details: [
