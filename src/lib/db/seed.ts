...
const permissions = [
  ...
  },
  {
    ...
    description: "Schedule and manage pest control services",
  },
  ...
  { id: "settings", name: "System Settings", description: "Configure system-wide settings" },
  {
    ...
    description: "Manage customer complaints and feedback",
  },
  {
    id: "notifications",
...
const existingCustomers = [
  {
    ...
    label: "Building A, Flat 304",
    address: "Building A, Flat 304, Andheri East, Mumbai, Maharashtra 400069",
  },
  {
    name: "Priya Patel",
    phone: "+91 9876543211",
    email: "priya.patel@example.com",
    label: "Building C, Flat 101",
    address: "Building C, Flat 101, Bandra West, Mumbai, Maharashtra 400050",
  },
  {
    name: "Neha Kapoor",
    phone: "+91 9876543212",
    email: "neha.kapoor@example.com",
    label: "Building D, Flat 203",
    address: "Building D, Flat 203, Powai, Mumbai, Maharashtra 400076",
  },
  {
    name: "Vikram Malhotra",
    phone: "+91 9876543213",
    email: "vikram.malhotra@example.com",
    label: "Building B, Flat 502",
    address: "Building B, Flat 502, Koramangala, Bangalore, Karnataka 560034",
  },
  {
    name: "Rahul Verma",
    phone: "+91 9876543214",
    email: "rahul.verma@example.com",
    label: "Building B, Flat 303",
    address: "Building B, Flat 303, Indiranagar, Bangalore, Karnataka 560038",
  },
  {
    name: "Suresh Menon",
    phone: "+91 9876543215",
    email: "suresh.menon@example.com",
    label: "Building E, Flat 105",
    address: "Building E, Flat 105, Alwarpet, Chennai, Tamil Nadu 600018",
  },
  {
    name: "Ananya Singh",
    phone: "+91 9876543216",
    email: "ananya.singh@example.com",
    label: "Building F, Flat 201",
    address: "Building F, Flat 201, Salt Lake, Kolkata, West Bengal 700091",
  },
  {
    name: "Rajesh Kumar",
    phone: "+91 90000 10001",
    email: "rajesh.kumar.customer@example.com",
    label: "B-101, Sunflower Apartments",
    address: "B-101, Sunflower Apartments, MG Road, Bangalore, Karnataka 560001",
  },
  {
    name: "Priya Sharma",
    phone: "+91 90000 10002",
    email: "priya.sharma.customer@example.com",
    label: "Flat 205, Green Valley Society",
    address: "Flat 205, Green Valley Society, Sector 12, Noida, UP 201301",
  },
  {
    name: "Amit Patel",
    phone: "+91 90000 10003",
    email: "amit.patel.customer@example.com",
    label: "301, Business Tower",
    address: "301, Business Tower, SG Highway, Ahmedabad, Gujarat 380015",
  },
  {
    name: "Rohit Khanna",
    phone: "+91 9876543222",
    email: "rohit.khanna@example.com",
    label: "Tower 4, Flat 1201",
    address: "Tower 4, Flat 1201, Hiranandani Gardens, Powai, Mumbai, Maharashtra 400076",
  },
  {
    name: "Kavita Reddy",
    phone: "+91 9876543223",
    ...
    label: "Villa 18",
    address: "Villa 18, Jubilee Hills, Hyderabad, Telangana 500033",
  },
  {
    name: "Aryan Gupta",
    phone: "+91 9876543224",
    email: "aryan.gupta@example.com",
    label: "House 22, Sector 45",
    address: "House 22, Sector 45, Gurugram, Haryana 122003",
  },
  {
    name: "Arjun Nair",
    phone: "+91 9876543225",
    email: "arjun.nair@example.com",
    label: "Flat 8B, Marine Drive",
    address: "Flat 8B, Marine Drive, Kochi, Kerala 682031",
  },
  {
    name: "Meera Shah",
    phone: "+91 9876543226",
    email: "meera.shah@example.com",
    label: "Shop 12, CG Road",
...
const existingComplaints = [
  ...
  },
  {
    ...
    date: "May 11, 2025",
    action: "Update status",
    issue: "Agent arrived late and was unprofessional",
  },
  {
    id: 5,
    customer: "Rahul Verma",
    ...
    date: "May 11, 2025",
    action: "Update status",
    issue: "Agent did not explain the treatment",
  },
  {
    id: 6,
    customer: "Suresh Menon",
    ...
    date: "May 29, 2025",
    action: "Update status",
    issue: "Mosquitoes returned within a week",
  },
  {
    id: 7,
    customer: "Ananya Singh",
  ...
  },
  {
    ...
    date: "June 1, 2025",
    action: "Update status",
    issue: "Technician arrived 90 minutes late",
  },
  {
    id: 9,
    customer: "Suresh Menon",
    ...
    date: "June 1, 2025",
    action: "Update status",
    issue: "Incomplete coverage of kitchen area",
  },
  {
    id: 10,
    customer: "Ananya Singh",
  ...
  },
  {
    ...
    date: "July 1, 2025",
    action: "Update status",
    issue: "Missed the scheduled window",
  },
  {
    id: 12,
    customer: "Suresh Menon",
    ...
    date: "July 10, 2025",
    action: "Update status",
    issue: "Redo required after complaint",
  },
];
...
const templates = [
  ...
  },
  {
    ...
    message:
      "We value your feedback! Please share your experience with our {service_type} service...",
  },
];
...
async function seed() {
  ...
  const salesIds = existingStaff
    .filter((item) => item.role === "salesperson" && item.status === "active")
    .map((item) => staffId(item.name));
  ...
  const generatedCustomers = customers.filter(
    (item) => !existingContracts.some((contractRow) => contractRow.customer === item.name),
  );
  ...
  for (const customerRow of generatedCustomers.slice(0, 22)) {
    ...
    const expiry = addDays(
      start,
      status === "Expired" ? 80 : status === "Expiring Soon" ? 100 : 140,
    );
  ...
  for (const contractRow of contracts) {
    ...
    for (let visit = 0; visit < visitCount && serviceId < 50; visit += 1) {
      ...
      await db.insert(service).values({
        ...
        status,
        amount:
          status === "Unscheduled" || status === "Expired" ? 0 : 1500 + Math.floor(random() * 3500),
  ...
  const extraServicePool = generatedServices.filter(
    (item) => item.id > 12 && item.status !== "Completed",
  );
      ...
      value: JSON.stringify([
        {
          ...
          answer:
            "Homes are priced by pest type, BHK size, and duration. Commercial sites are priced by pest type, square feet, and duration.",
        },
        {
